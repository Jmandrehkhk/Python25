...
print(f"Mõõdetava kuu temp: {mootmine[1:]}")

print(f"Kõrgeim temp: {max(mootmine[1:])}")
print(f"Madalaim temp: {min(mootmine[1:])}")
print(f"Keskmine temp: {sum(mootmine[1:]) / len(mootmine[1:]):.2f}")
